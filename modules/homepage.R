    ...
    navset_card_tab(
      ...
      nav_panel(
        ...
        HTML("
             ...
             <ul 'font-size: 22px;'>
             <li><strong>Data Preprocessing</strong> - Prepare and preprocess your spectral data for modeling
             <li><strong>Static models</strong> - Make soil property predictions using built-in models, developed using the USDA NRCS NSSC-KSSL mid-infrared (MIR) spectral library.
             <li><strong>Customized models</strong> - Generate tailored predictions from your spectral dataset using the K-nearest neighbor algorithm to identify and subset spectrally similar samples from the NSSC-KSSL spectral library.  
             <li><strong>Build your own machine learning models</strong> - Develop and train custom models tailored to your dataset for advanced soil analytics. 
             </ul>
      ...
      nav_panel(
        ...
        fluidRow(
          column(width = 12,
               ...
               <p> If you already have aggregated .csv file containing all spectral scans, including sample IDs and absorbance values organized by wavenumber,
               then go to the Aggregated CSV File tab to upload your file and begin preprocessing  
               ...
               <p>If you would like preprocessing spectral data tailored to your needs, click on the <strong>custom</strong> preprocessing. 
                     ...
                     HTML("
                            ...
                            <p>
                             ...
                             <div style='display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; font-family: Arimo;'>
                               ...
                               <ul style='list-style-type: disc; padding-left: 10px;'>
                               <li>Total Carbon</li>
                               <li>Estimated Organic Carbon</li>
                               <li>Carbon (hpom)</li>
                               <li>Carbon (hmin)</li>
                            ...
                            <table style='width: 50%; border-collapse: collapse;'>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <td style='border: 1px solid #ddd; padding: 8px;'>3990</td>
                                  <td style='border: 1px solid #ddd; padding: 8px;'>Absorbance at  3990 cm<sup>-1</sup></td>
                                </tr>
                                <tr>
                            ...
                            <p>
                              If your spectral data is not preprocessed, use the <strong>Data Preprocessing</strong> tab in the web tool to generate a 
                              compatible preprocessed .CSV file.<br>
                              If your spectral data is not yet preprocessed follow these steps: 
                              <li>•	Use the <strong>Data Preprocessing </strong> tab - the \"Default\" preprocessing option in the web tool to generate a compatible preprocessed .CSV file. 
                              <li>•	Compress your OPUS (.0) or .CSV files into a .zip file and upload it in the Data Preprocessing tab. 
                              <li>•	Choose the “Default” button in the custom preprocessing options.  
                              <li>•	Click \"Download\" (located at the bottom left) and use the downloaded file for predictions. 
                            </p>
                            <br>
                            ...
                            <p>
                              ...
                              If a specific stratification model is not available, it means the stratified dataset did not have enough data to develop a machine learning model for that category.
                            </p>
                            <br>
                   ...
                   tabPanel(
                     ...
                     HTML("
                            ...
                            <p>
                              The Customized Model tab allows you to build machine learning models using KSSL data with spectra similar to your local data. It refines and personalizes the built-in models by leveraging the similarity in your spectral data and the KSSL spectral library.
                            </p>
                            <br>
                            <p>
                            <u>How It Works</u><br>
                            The Customized Model tab uses the K-Nearest Neighbor (KNN) algorithm in the Principal Component Analysis (PCA) space. It identifies spectra from the KSSL dataset similar to your local spectral data. The neighboring spectra are then used to adjust and customize the machine learning models, improving the predictions.
                            </p>
                            <br>
                            ...
                            The PCA plot displays the KSSL data, the input data you upload (overlaid on top of the KSSL data points), and the subset of KSSL data
                            points selected by the algorithm based on your neighbor selection. The more neighbors you select, the longer it will take for the model to train and predict.<br>
  ...
  "))
        ...
        tags$div(
          ...
          tags$div(
            ...
            p( tags$a(href = "mailto:edemain@wisc.edu",
                      "edemain@wisc.edu") )
          ),
          ...
          tags$div(
            ...
            p( tags$a(href = "mailto:weerasekara@wisc.edu",
                      "weerasekara@wisc.edu") )
          ),
          ...
          tags$div(
            ...
            p( tags$a(href = "mailto:zhang878@wisc.edu",
                      "zhang878@wisc.edu") )
          ),
      ...
      navbarMenu(title = "Links",
                 ...
                 nav_item(
                   tags$a(
                     "MIR Soil Prediction Platform - User Guide (PDF)",
                     href     = "MIR Soil Prediction Platform - User Guide.pdf",   # www/static_model_sop.pdf
                     target   = "_blank",                 # open in a new tab
                     download = NA                        # …and offer Save-as
                   )
                 ),
                 ...
                 nav_item(
                   tags$a(
                     "Static and Customized Models Test File",
                     href     = "static+knnmodels_test.csv",
                     target   = "_blank",
                     download = NA
                   )
                 ),
                 ...
                 nav_item(
                   tags$a(
                     "Build Your Own Models Test File",
                     href     = "BYOmodels_test.csv",
                     target   = "_blank",
                     download = NA
                   )
                 ),
                 ...
                 nav_item(
                   tags$a(
                     "Data Preprocessing Test File (CSV)",
                     href    = "aggregated_spectral_test.csv",
                     target  = "_blank",
                     download = NA
                   )
                 ),
                 ...
                 nav_item(
                   tags$a(
                     "Data Preprocessing Test File (ZIP)",
                     href   = "opus+csvrawtest.zip",
                     target = "_blank",
                     download = NA
                   )
                 ),
                 nav_item(
                   tags$a(
                     "Feedback",
                     href = "https://forms.gle/c8Qz8rkwYRWCSvne7",
                     target = "_blank"
                   )
                 )
...
homepageServer <- function(id, shared) {
  moduleServer(
    ...
    digraph flowchart {
      ...
      builtIn  -> custom        [style = invis, arrowhead = none, minlen = 20];
