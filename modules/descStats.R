...
strat_names_list <- list(
  ...
  lulc = c("Cultivated crops" = "Cultivated crops", "Decidous trees" = "Decidous trees",
           "Developed" = "Developed", "Evergreen forests" = "Evergreen forests",
           "Herbaceous wetlands" = "Herbaceous wetlands", "Herbaceous" = "Herbaceous",
           "Mixed forests" = "Mixed forests", "pasture" = "Pasture", 
           "Shrub" = "Shrub", "Woody wetlands" = "Woody wetlands", "Barren" = "Barren", "Croplands" = "Croplands", 
           "Deciduous forests" = "Deciduous forests", "Developed" = "Developed", "Grasslands" = "Grasslands", "Open water" = "Open water",
           "Pasture" = "Pasture", "Shrublands" = "Shrublands", "Woody wetlands" = "Woody wetlands", "Herbaceous wetlands" = "Herbaceous wetlands"),
...
descriptiveStatsServer <- function(id, shared, load_spectral_data_memo) {
  moduleServer(id, function(input, output, session) {
    ...
    big_table_stats <- function(df) {
      ...
      lulc_stats     <- cat_stats(df, "LULC",    "LULC",         LULC_list_)
    ...
    base_data <- reactive({
      ...
      if (!"LULC" %in% names(df))          df$LULC <- NA_character_
